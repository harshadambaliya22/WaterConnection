...
@for $i from 0 through 100 {
  $spacers: map-merge($spacers, ($i: #{$i}px));
}
...
@for $i from 8 through 44 {
  $font-sizes: map-merge($font-sizes, ($i: #{$i}px));
}
...
// Create a full margin scale (e.g., from 1px to 100px)
$zindex-levels: () !default;

@for $i from -1 through 30 {
  $zindex-levels: map-merge($zindex-levels, ($i: $i));
}
